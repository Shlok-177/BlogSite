        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            ...
            <div className="flex flex-col pt-3">
              <a
                className="rounded-full border px-8 py-2 text-center text-sm font-light text-gray-700 transition-colors hover:border-[#075E54] hover:bg-[#075E54] hover:text-white hover:shadow dark:text-white"
                href="https://api.whatsapp.com/send?phone=9726666647&text=Hey Shlok"
                data-screen-name="Shlok Jadeja"
                target="_blank"
                rel="noreferrer noopener"
              >
                <AiOutlineWhatsApp className="mr-2 mb-0.5 inline h-5 w-5" />
                Say Hi!
              </a>
            </div>
          </div>
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                {text1}
                <Link
                  href={'https://www.linkedin.com/in/shlok-jadeja-8b9793209/details/certifications/'}
            ...
            <p className="hidden md:block">
              ...
              >
                <span className="text-black dark:text-white">
                  MERN stack Web Development and some my personal Project.{' '}
                </span>
              </RoughNotation>
              At the same time I am{' '}
              <RoughNotation
              ...
              >
                ...
                Full-stack web Development and Software Engineer
              </RoughNotation>
            </p>
            <br />
            <p>
              ...
              <Link
                href={'mailto:shlokjadeja177@gmail.com'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Mail
                <svg
              ...
              or{' '}
              <Link
                href={'https://api.whatsapp.com/send?phone=9726666647&text=hi'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Whatsapp
                <svg
