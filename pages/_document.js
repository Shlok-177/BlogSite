    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my Personal Toughts and new blogs in various feild . I am a CSE studnet and i like to creae more site and project "
          />
